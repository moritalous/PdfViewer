...
public class PdfRendererBasicFragment extends Fragment implements
	...
	/**
	 * {@link android.widget.ImageView} that shows a PDF page as a
	...
	public PdfRendererBasicFragment(Uri uri) {
		this.uri = uri;
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		int index = 0;
		// If there is a savedInstanceState (screen orientations, etc.), we
	...
	/**
	 * Closes the {@link android.graphics.pdf.PdfRenderer} and related
	 * resources.
	 * 
	 * @throws java.io.IOException
	 *             When the PDF file cannot be closed.
	 */
	...
	private void showPage(int index) {
		...
		// Pass nulls to get
		// the default result.
		// Pass either RENDER_MODE_FOR_DISPLAY or RENDER_MODE_FOR_PRINT for the
		// last parameter.
	...
	/**
	 * Updates the state of 2 control buttons in response to the current page
	 * index.
	 */
	private void updateUi() {
		...
		getActivity().setTitle(
				getString(R.string.app_name, index + 1, pageCount));
	}

	/**
	 * Gets the number of pages in the PDF. This method is marked as public for
	 * testing.
	 * 
